...
Route::group(['namespace' => 'Admin'], function() {
    ...
    Route::group(['middleware' => 'checkLogin'], function() {
        ...
        Route::get('/login', 'ActivityController@add')->name('activity.add');
...
Route::group(['namespace' => 'Api'], function() {
    ...
    Route::any('/wechat/oauth2', 'WeChatController@oauth2');
    Route::any('/wechat/wxCallBack', 'WeChatController@wxCallBack');
    Route::any('/wechat/jssdkConfig', 'WeChatController@jssdkConfig');
